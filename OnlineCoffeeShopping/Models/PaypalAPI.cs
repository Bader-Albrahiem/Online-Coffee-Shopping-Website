...
namespace OnlineCoffeeShopping.Models
{
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "sb-rkd47h25205357_api1.business.example.com";
        private string APIPassword = "H87L4ADZUFU4NQ8B";
        private string APISignature = "AIsxAyj.22BaMpWKEt69gfb4cxBHAtaDne9bwV.4dfzbhtf68Hi.Iw8n";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            string returnURL = "https://localhost:44397/Users/Checkout/CheckOutReview.aspx";
            string cancelURL = "https://localhost:44397/Users/Checkout/Checkout.aspx";

            NVPCodec encoder = new NVPCodec();
            encoder["METHOD"] = "SetExpressCheckout";
            encoder["RETURNURL"] = returnURL;
            encoder["CANCELURL"] = cancelURL;
            encoder["BRANDNAME"] = "OnlineCoffeeShppoing";
            ...
            {
                encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].ProductName.ToString();
                encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].UnitUSDprice.ToString();
